...
<section class="belief white-bg page-section-pt mb-50">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="section-title text-center">
          ...
          <h2> <span class="text-orange">MENU OF </span> THE DAY</h2>
          <p>Try our clam chowder shrimp dip blackened grouper salad</p>
        </div>
      </div>
    </div>
   <div class="row justify-content-center">
    <div class="col-lg-3 col-md-4 col-sm-6">
      <div class="feature-1">
          <div class="menu-body menu-white">
    ...
    <div class="col-lg-3 col-md-4 col-sm-6">
      <div class="feature-1">
        ...
        <div class="menu-details">
          <div class="menu-title clearfix mb-0">
            <h4>Pozole</h4>
            <span class="price">$99.0</span>
          </div>
        </div>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-3 col-md-4 col-sm-6">
        <div class="feature-1">
          <div class="menu-body menu-white">
            <div class="menu-thumbnail">
              <img class="img-fluid center-block" src="images/dish/Tacos al pastor.png" alt="" style="border-radius: 50%;">
            </div>
            <div class="menu-details">
              <div class="menu-title clearfix">
    ...
    <div class="col-lg-3 col-md-4 col-sm-6">
      <div class="feature-1">
          <div class="menu-body menu-white">
            <div class="menu-thumbnail">
              <img class="img-fluid center-block" src="images/dish/Tamales.png" alt="" style="border-radius: 50%;">
            </div>
            <div class="menu-details">
              <div class="menu-title clearfix">
                <h4>Tamales</h4>
    ...
    <div class="feature-1">
          <div class="menu-body menu-white">
          <div class="menu-thumbnail">
            <img class="img-fluid center-block" src="images/dish/Tostadas.png" alt="" style="border-radius: 50%;">
          </div>
          <div class="menu-details">
            <div class="menu-title clearfix">
              <h4>Tostadas</h4>
  ...
  <div class="col-lg-3 col-md-4 col-sm-6">
   ...
   <div class="col-lg-3 col-md-4 col-sm-6">
      <div class="feature-1">
            <div class="menu-body menu-white">
            <div class="menu-thumbnail">
              <img class="img-fluid center-block" src="images/dish/15.png" alt="">
            </div>
            <div class="menu-details">
              <div class="menu-title clearfix">
