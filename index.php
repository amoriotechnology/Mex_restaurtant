    ...
    <div id="rev_slider_7_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.2.6">
      <ul>  <!-- SLIDE  -->
        ...
        <div class="tp-caption tp-resizeme text-orange"
          ...
          data-splitout="none"
          data-responsive_offset="on"
        style="z-index: 14; white-space: nowrap; font-size: 70px; line-height: 70px; font-weight: 400; font-family:Lilita One;text-transform:uppercase;">Mexican Dish</div>
        <!-- LAYER NR. 11 -->
        <div class="tp-caption   tp-resizeme mo-text-uppercase"
          ...
          data-splitout="none"
          data-responsive_offset="on"
          style="z-index: 15; min-width: 1270px; max-width: 1270px; max-width: 106px; max-width: 106px; white-space: normal; font-size: 24px; line-height: 47px; font-weight: 400; color: rgba(255, 255, 255, 1.00);font-family:Lilita One;text-transform:uppercase;">Grab life by the fork</div>
        <!-- LAYER NR. 12 -->
        <div class="tp-caption tp-resizeme button-red-medium mo-btn button"
          ...
          data-splitout="none"
          data-responsive_offset="on"
        style="z-index: 16; white-space: nowrap; font-size: 16px; line-height: 14px; font-weight: 300; font-family:Open Sans; padding:14px 25px 14px 25px; border-radius:3px 3px 3px 3px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;">Read More </div>
        </li>
        <!-- SLIDE  -->
        ...
        <div class="tp-caption   tp-resizeme"
          ...
          data-splitout="none"
          data-responsive_offset="on"
        style="z-index: 18; white-space: nowrap; font-size: 100px; line-height: 100px; font-weight: 400; color: rgba(66, 66, 66, 1.00);font-family:Lilita One;text-transform:uppercase;">Mexican Dish</div>
        <!-- LAYER NR. 15 -->
        <div class="tp-caption tp-resizeme mo-text-uppercase"
          ...
          data-splitout="none"
          data-responsive_offset="on"
        style="z-index: 19; min-width: 753px; max-width: 753px; max-width: 97px; max-width: 97px; white-space: normal; font-size: 24px; line-height: 47px; font-weight: 400; color: rgba(66, 66, 66, 1.00);font-family:Lilita One;text-transform:uppercase;">Experience a taste of Mexico.</div>
        <!-- LAYER NR. 16 -->
        <div class="tp-caption tp-resizeme button-red-medium mo-btn button"
          ...
          data-splitout="none"
          data-responsive_offset="on"
        style="z-index: 20; white-space: nowrap; font-size: 16px; line-height: 14px; font-weight: 400; font-family:Open Sans; padding:14px 25px 14px 25px; border-radius:3px 3px 3px 3px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;">Discover More </div>
        </li>
      </ul>
...
<section class="about-2 white-bg">
  <div class="object-top">
    <div class="object-right mt-60">
      <img class="img-fluid" src="images/object/08.png" alt="">
    </div>
  </div>
<div class="container">
  <div class="row">
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="right-img mt-40">
            <img class="img-fluid" src="images/object/12.png" alt="">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="about-content mt-100">
            <h2><span class="text-orange">Welcome to</span> our Restaurtant</h2>
            <p>Whatever your occasion, We makes it one to remember!</p>
            <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos <a class="text-orange" href="service.html">Service</a> et quas occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt distinctio. Nam  distinctio. Nam libero tempore, cum soluta nobis  libero tempore, cum soluta nobis  mollitia animi, id est laborum et dolorum fuga,</p>
            <p>Et harum <a class="text-orange" href="menu-style-1.html">Our menu</a> rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque.</p>
            <a href="#" class="button mt-10">Red More</a></div>
          </div>
        </div>
    </div>
  </div>
...
<section class="our-menu dark black-bg pb-20">
  <div class="object-top-bottom">
    <div class="object-left">
      <img class="img-fluid" src="images/object/03.png" alt="">
    </div>
    <div class="object-right">
      <img class="img-fluid" src="images/object/04.png" alt="">
    </div>
  </div>
  <div class="page-section-pt pb-10 position-relative">
    <div class="container">
      <div class="row">
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6">
          <div class="menu-body menu-left menu-white">
            <div class="menu-thumbnail">
              <img class="img-fluid center-block" src="images/dish/bbq chicken shawarma.png" alt="" style="border-radius: 50%;">
            </div>
            <div class="menu-details">
              <div class="menu-title clearfix">
                <h4>BBQ Chicken Shawarma</h4>
          ...
          <div class="menu-body menu-left menu-white">
            <div class="menu-thumbnail">
              <img class="img-fluid center-block" src="images/dish/Chiles en nogada.png" alt="" style="border-radius: 50%;">
            </div>
            <div class="menu-details">
              <div class="menu-title clearfix">
          ...
          <div class="menu-body menu-left menu-white">
            <div class="menu-thumbnail">
              <img class="img-fluid center-block" src="images/dish/Elote.png" alt="" style="border-radius: 50%;">
            </div>
            <div class="menu-details">
              <div class="menu-title clearfix">
                <h4>Elote</h4>
          ...
          <div class="menu-body menu-left menu-white">
            <div class="menu-thumbnail">
              <img class="img-fluid center-block" src="images/dish/Enchiladas.png" alt="" style="border-radius: 50%;">
            </div>
            <div class="menu-details">
              <div class="menu-title clearfix">
                <h4>Enchiladas</h4>
        ...
        <div class="col-lg-6 col-md-6">
          <div class="menu-body menu-left menu-white">
            <div class="menu-thumbnail">
              <img class="img-fluid center-block" src="images/dish/Guacamole.png" alt="" style="border-radius: 50%;">
            </div>
            <div class="menu-details">
              <div class="menu-title clearfix">
                <h4>Guacamole</h4>
          ...
          <div class="menu-body menu-left menu-white">
            <div class="menu-thumbnail">
              <img class="img-fluid center-block" src="images/dish/Mexican Shawarma Plate.png" alt="" style="border-radius: 50%;"> 
            </div>
            <div class="menu-details">
              <div class="menu-title clearfix">
                <h4>Mexican Shawarma Plate</h4>
                <span class="price">$99.0</span>
              </div>
              <div class="menu-description">
          ...
          <div class="menu-body menu-left menu-white">
            <div class="menu-thumbnail">
              <img class="img-fluid center-block" src="images/dish/Mole.png" alt="" style="border-radius: 50%;">
            </div>
            <div class="menu-details">
              <div class="menu-title clearfix">
                <h4>Mole</h4>
          ...
          <div class="menu-body menu-left menu-white">
            <div class="menu-thumbnail">
              <img class="img-fluid center-block" src="images/dish/Pozole.png" alt="" style="border-radius: 50%;">
            </div>
            <div class="menu-details">
              <div class="menu-title clearfix">
                <h4>Pozole</h4>
          ...
          <div class="item">
            <div class="team">
              <div class="team-images">
                <img class="img-fluid center-block" src="images/team/team.png" alt="">
              </div>
              <div class="team-content">
                <div class="team-description">
                  <h6>Martin Smith</h6>
                  <span>Sales exclusive</span>
                </div>
          ...
          <div class="item">
            <div class="testimonial-block white-text">
              <div class="testimonial-avatar">
                <img src="images/team/test.png" alt="">
              </div>
          ...
          <div class="item">
            <div class="blog-entry">
              <div class="blog-entry-image">
                <img class="img-fluid" alt="" src="images/event/event.png">
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12">
          <div class="section-title text-center">
            ...
            <h2 class="text-white"> <span class="text-orange">Make </span> Reservation</h2>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-submit mt-10 mb-30 text-center">
                    <button id="submit" name="Submit" type="submit" onclick="return false;" class="button gray uppercase"> Book A Table</button>
                  </div>
                </div>
              </div>
              <div class="bottom-text text-white text-center">You can also call : + <span class="text-orange"><strong>1 123 456 008 </strong></span> to make a reservation.</div>
            </div>
          </form>
        </div>
      </div>
